...
# 1. Update setEditForm initialization to include guardianRelation
init_pattern = r"(guardianName: student\.guardianName \|\| '',\n)(\s*fatherName: student\.fatherName \|\| student\.guardianName \|\| '',)"
init_replacement = r"\1            guardianRelation: student.guardianRelation || '',\n\2"
content = re.sub(init_pattern, init_replacement, content)

# 2. Replace the form body
...
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated StudentsManagement.jsx")
